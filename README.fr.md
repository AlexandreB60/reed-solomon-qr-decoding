...
Lorsque le nombre d'erreurs est strictement inférieur à `t`, la matrice du système est singulière. La résolution se fait donc par une mise sous forme échelonnée réduite, qui accepte ce cas et renvoie une solution particulière en fixant les inconnues libres à zéro.
